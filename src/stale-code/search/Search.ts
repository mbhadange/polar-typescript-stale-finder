...
/**
 * Sets up the map by setting all the file names to 0 that have an extenstion of ts or tsx
 * Checks if file is already in the map
 */
function SetUpMap() {
...
/**
 * Sorts and formats the map so it is in printed properly in a table
 */
function FormatsMap() {
    /**
...
/**
 * Finds the full path of the file that is being imported 
 * Updates the Map value of that file
 */
function UpdateMap() {
